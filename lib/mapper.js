...
module.exports.PowerfromActive = function (isactive) {
    switch (isactive) {
        case Characteristic.Active.INACTIVE: return Power.Off;
        case Characteristic.Active.ACTIVE: return Power.On;
    }
};

module.exports.ActivefromPower = function (isactive) {
    switch (isactive) {
	    case Power.Off: return Characteristic.Active.INACTIVE;
	    case Power.On: return Characteristic.Active.ACTIVE;
    }
};
